...
import com.circle.enums.EnumCode;
import com.circle.pojo.ExceptionResponseResult;
import com.circle.pojo.ResponseData;
...
@RestControllerAdvice(basePackages  = "com.circle.controller")   // 控制器类增强：可以对Controller中所有使用@RequestMapping注解的方法增强
public class ResponseResult<T> implements ResponseBodyAdvice<Object> {
    ...
    public Object beforeBodyWrite(Object body, MethodParameter returnType, MediaType selectedContentType,
        ...
        } else if (body instanceof ExceptionResponseResult) {
            ResponseData.error(EnumCode.SYSTEM_ERROR, body);
        }
